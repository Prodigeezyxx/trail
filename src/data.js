 ...
 */
export const LAYERS = [
  { id: "services", name: "Public services", track: "transparency", color: "#4ade80", evidence: "Service charters, office hours, complaint routes" },
  { id: "budget", name: "Budgets & spending", track: "transparency", color: "#22c55e", evidence: "Published allocations, county budget documents" },
  { id: "procurement", name: "Procurement & contracts", track: "transparency", color: "#a3e635", evidence: "Tender awards, contract registers, beneficial owners" },
  { id: "audit", name: "Audit & oversight", track: "transparency", color: "#84cc16", evidence: "Auditor-general reports, oversight findings" },
  { id: "elections", name: "Representation", track: "transparency", color: "#14b8a6", evidence: "Ward boundaries, representative contacts, sitting calendars" },
  { id: "water", name: "Water & sanitation", track: "stability", color: "#38bdf8", evidence: "Water point status, maintenance contacts, borehole data" },
  { id: "land", name: "Land & tenure", track: "stability", color: "#0ea5e9", evidence: "Registry status, consultation records, dispute routes" },
  { id: "displacement", name: "Displacement", track: "stability", color: "#6366f1", evidence: "Movement figures, registration points, return support" },
  { id: "warning", name: "Early warning", track: "stability", color: "#8b5cf6", evidence: "Drought, flood and hazard alerts with lead times" },
  { id: "mediation", name: "Local mediation", track: "stability", color: "#a78bfa", evidence: "Peace committees, customary and formal dispute routes" },
  { id: "rights", name: "Rights & legal aid", track: "safety", color: "#f472b6", evidence: "Free legal aid, paralegal networks, complaint mechanisms" },
  { id: "protection", name: "Reporting & protection", track: "safety", color: "#ec4899", evidence: "Ombudsman, anti-corruption, police oversight, helplines" },
  { id: "gbv", name: "GBV & child protection", track: "safety", color: "#f43f5e", evidence: "Referral pathways, survivor services, safe reporting" },
  { id: "health", name: "Health access", track: "safety", color: "#fb7185", evidence: "Facility staffing, medicine availability, referral routes" },
  { id: "food", name: "Food & market prices", track: "stability", color: "#fbbf24", evidence: "Staple price series, market data, shortage reporting" },
];
